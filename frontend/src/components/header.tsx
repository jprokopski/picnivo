              ...
              <div className="relative inline-flex" ref={menuRef}>
                ...
                >
                  <Avatar
                    name={displayName}
                    size={36}
                    className="max-[480px]:size-10.5!"
                  />
                </button>

                {menuOpen && (
                  <div
                    className="bg-card absolute top-[calc(100%+10px)] right-0 z-60 min-w-58 origin-top-right animate-[web-sheet-in_140ms_cubic-bezier(0.16,1,0.3,1)_both] rounded-(--r-md) border border-(--line) p-2 shadow-(--sh-lg)"
                    role="menu"
                  >
