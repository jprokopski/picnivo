...
- [x] 2.1 Type checking passes: `pnpm exec tsc --noEmit` — 8c56f77
- [x] 2.2 Tests pass (incl. new `AuthPanel` tests): `pnpm test` — 8c56f77
- [x] 2.3 Linting passes: `pnpm lint` — 8c56f77
- [x] 2.4 Production build succeeds: `pnpm build` — 8c56f77
- [x] 2.5 No dead tokens anywhere in `src/` (grep clean) — 8c56f77
- [x] 2.6 Lingui catalog re-extracts cleanly: `pnpm extract` — 8c56f77

#### Manual

- [x] 2.7 `/login` renders the design split-panel on the current palette — 8c56f77
- [x] 2.8 Signin/signup toggle updates URL `mode`; name field appears only in signup — 8c56f77
- [x] 2.9 Show/hide password toggle works — 8c56f77
- [x] 2.10 Email signin, email signup, and Google all land on `/events` (or safe redirect) — 8c56f77
- [x] 2.11 `/register` redirects to `/login` in signup mode — 8c56f77
- [x] 2.12 Brand panel is responsive on narrow viewports — 8c56f77
